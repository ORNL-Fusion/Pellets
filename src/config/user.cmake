...
# Set NetCDF base path
set(INCLUDE_DIR "/opt/homebrew/include/")
set(LIB_DIR "/opt/homebrew/lib/")

# Set path for the NetCDF headers and libs.
set(NETCDF_INC_PATH "${INCLUDE_DIR}" CACHE PATH "Path to NetCDF include directory")
set(NETCDF_LIB_PATH "${LIB_DIR}" CACHE PATH "Path to NetCDF library directory")
